    ...
    <>
      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-theme-row">
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="sidebar-theme-icon">
          ...
          <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" stroke="none" className="sidebar-theme-icon">
